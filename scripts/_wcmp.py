...
b = transformers.Gemma3ForCausalLM.from_pretrained(base, dtype=torch.float32)
c = transformers.Gemma3ForCausalLM.from_pretrained(ck, dtype=torch.float32)
